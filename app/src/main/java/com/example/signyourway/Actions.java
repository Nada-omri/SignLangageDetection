...
import com.example.signyourway.ModelClass;

import com.example.signyourway.R;
import com.example.signyourway.WonActivity;
...
public class Actions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initializeSecondaryFirebaseApp();
        ...
        databasereference = secondaryDatabase.getReference("Question");
        ...
        countDownTimer = new CountDownTimer(progressStatus * 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Dialog dialog = new Dialog(Actions.this);
    ...
    private void initializeSecondaryFirebaseApp() {
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setApplicationId("1:761813710314:android:91eabc9207334c48102e93")
                .setApiKey("AIzaSyDlHeGbKNHiTIFGzAOuHFV1NCwuIQTVQMg")
                .setDatabaseUrl("https://quizz-428c5-default-rtdb.firebaseio.com")
                .build();
    ...
    private void Gamewon() {
        Intent intent=new Intent(Actions.this, WonActivity.class);
